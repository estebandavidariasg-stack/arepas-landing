      ...
      <section id="ubicaciones">
        ...
        >
          <h2
            ...
            style={{ fontSize: 'clamp(28px, 5vw, 72px)', marginBottom: '16px' }}
          >
            ...
            {ubicaciones.map((u, i) => (
              ...
              >
                ...
                <h3
                  ...
                  style={{ fontSize: '25px',color: '#3D6B2C' }}
                >
                  {u.titulo}
                </h3>
                ...
                {/* Botón centrado con ícono flecha */}
                <motion.a
                  href={u.maps}
                  target="_blank"
                  rel="noreferrer"
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="font-fredoka font-semibold text-white rounded-full flex items-center justify-center gap-3 mt-2"
                  style={{
                    fontSize: '22px',
                    padding: '14px',
                    background: 'linear-gradient(135deg, #E8820C 0%, #F5A623 50%, #FFBE3D 100%)',
